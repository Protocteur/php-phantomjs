...
namespace protocteur\PhantomJs\Tests\Integration;

use protocteur\PhantomJs\Test\TestCase;
...
EOF;
    ...
    public function testResponseContains200StatusCodeIfPageIsSuccessfullyLoaded()
    {
        ...
        $request->setUrl('http://www.protocteur.kiwi/tests/test-default');
    ...
    public function testCanAddCookiesToRequest()
    {
        ...
        $request->setMethod('GET');
        $request->setUrl('http://www.protocteur.kiwi/tests/test-default');
        $request->addCookie('test_cookie', 'TESTING_COOKIES', '/', '.protocteur.kiwi');
    ...
    public function testCanLoadCookiesFromPersistentCookieFile()
    {
        ...
        $request->setMethod('GET');
        $request->setUrl('http://www.protocteur.kiwi/tests/test-default');
        $request->addCookie('test_cookie', 'TESTING_COOKIES', '/', '.protocteur.kiwi', true, false, ($expireAt * 1000));

        $client->send($request, $response);

        $this->assertContains('test_cookie=TESTING_COOKIES; HttpOnly; expires=Mon, 16-Nov-2020 00:00:00 GMT; domain=.protocteur.kiwi; path=/)', file_get_contents($file));
    }
    ...
    public function testCanDeleteCookieFromPersistentCookieFile()
    {
        ...
        $this->assertNotContains('test_cookie=TESTING_COOKIES; HttpOnly; expires=Mon, 16-Nov-2020 00:00:00 GMT; domain=.protocteur.kiwi; path=/)', file_get_contents($file));
    }
    ...
    public function testCanDeleteAllCookiesFromPersistentCookieFile()
    {
        ...
        $request->setMethod('GET');
        $request->setUrl('http://www.protocteur.kiwi/tests/test-default');
        $request->addCookie('test_cookie_1', 'TESTING_COOKIES_1', '/', '.protocteur.kiwi', true, false, ($expireAt * 1000));
        $request->addCookie('test_cookie_2', 'TESTING_COOKIES_2', '/', '.protocteur.kiwi', true, false, ($expireAt * 1000));
        ...
        $this->assertNotContains('test_cookie_1=TESTING_COOKIES_1; HttpOnly; expires=Mon, 16-Nov-2020 00:00:00 GMT; domain=.protocteur.kiwi; path=/)', file_get_contents($file));
        $this->assertNotContains('test_cookie_2=TESTING_COOKIES_2; HttpOnly; expires=Mon, 16-Nov-2020 00:00:00 GMT; domain=.protocteur.kiwi; path=/)', file_get_contents($file));
    }
    ...
    public function testResponseContainsConsoleErrorIfAJavascriptErrorExistsOnThePage()
    {
        ...
        $request->setMethod('GET');
        $request->setUrl('http://www.protocteur.kiwi/tests/test-console-error');
    ...
    public function testPostRequestSendsRequestData()
    {
        ...
        $request->setUrl('http://www.protocteur.kiwi/tests/test-post');
        $request->setRequestData([
            'test1' => 'http://test.com',
            'test2' => 'A string with an \' ) / # some other invalid [ characters.',
        ]);
    ...
    public function testCaptureRequestSavesFileToLocalDisk()
    {
        ...
        $request->setMethod('GET');
        $request->setUrl('http://www.protocteur.kiwi/tests/test-capture');
    ...
    public function testLazyRequestReturnsResourcesAfterAllResourcesAreLoaded()
    {
        ...
        $request->setMethod('GET');
        $request->setUrl('http://www.protocteur.kiwi/tests/test-lazy');
