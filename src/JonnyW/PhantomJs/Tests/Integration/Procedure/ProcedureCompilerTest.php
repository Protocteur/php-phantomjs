...
use protocteur\PhantomJs\Procedure\ProcedureCompiler;
...
/** +++++++++++++++++++++++++++++++++++ **/
    ...
    public function testProcedureIsLoadedFromCacheIfCacheIsEnabled()
    {
        ...
        $renderer = $this->getMock('\protocteur\PhantomJs\Template\TemplateRendererInterface');
...
/** +++++++++++++++++++++++++++++++++++ **/
     ...
     *
     * @access protected
     * @return \protocteur\PhantomJs\Procedure\ProcedureCompiler
     */
